...
.trig-title{font-family:'DM Mono',monospace;font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:#eab308;margin-bottom:8px}
...
"""
    ...
    return (
        ...
        f"<div class='trig-title'>🎯 What would change this analysis</div>"
        ...
        # === DISCLAIMER ===
        f"<div class='disclaimer'>Generated by company-analyst skill (github.com/Kevin-XXX/company-analyst) using publicly available data. "
        f"Not financial or investment advice. All figures should be independently verified. "
        f"Investment decisions carry risk — they should reflect your own analysis and circumstances.</div>\n"
